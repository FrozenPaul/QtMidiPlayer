...
//    inline void repeatCallback(const std::function<void()>& callback_);
...
//    void* clbkFunCtxFinished=0;
    ...
    //add by Paul Halian
    MyNoteCallaback* note_is_pressed=0;
...
//    std::function<void()> clbkFunFinished;
    ...
    //add by Paul Halian
//    std::function<void(CxxMidi::Note, bool)> _note_is_pressed;
#endif // __cplusplus > 199711L
...
//                clbkFunCtxFinished = that->_clbkFunCtxFinished;
                ...
                //add by Paul Halian
                note_is_pressed = that->_note_is_pressed;
...
//                clbkFunFinished = that->_clbkFunFinished;
                ...
                //add by Paul Halian
//                _note_is_pressed = that->_noteCallBack;
#endif // __cplusplus > 199711L
            }
        }
        that-> _mutex.unlock();
...
//                clbkFunHeartbeat();
        ...
        //add By Paul Halian
        CxxMidi::Event event_our = (*that->_file)[trackNum][eventNum];
...
void Asynchronous::repeatCallback(MyNoteCallaback* callback)
{
    _mutex.lock();
...
//add by Paul Halian
//void Asynchronous::repeatCallback(const std::function<void()> &callback_)
//{
//    _mutex.lock();
//    _noteCallBack = callback_;
//    _mutex.unlock();
//}
