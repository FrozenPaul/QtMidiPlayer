...
void FileView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (FileView::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FileView::requestDeleteTrack)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (FileView::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FileView::requestAddTrack)) {
                *result = 1;
                return;
            }
        }
